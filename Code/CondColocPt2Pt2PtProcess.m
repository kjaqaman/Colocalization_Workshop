classdef CondColocPt2Pt2PtProcess < ImageAnalysisProcess
...
% 
        ...
        function obj = CondColocPt2Pt2PtProcess(owner,varargin)
            ...
            if nargin == 0
                ...
                super_args{1} = owner;
                super_args{2} = CondColocPt2Pt2PtProcess.getName;
                super_args{3} = @condColocPt2Pt2PtWrapper;
                if isempty(funParams)
                    funParams = CondColocPt2Pt2PtProcess.getDefaultParams(owner,outputDir);
                end
    ...
    methods (Static)
        function name = getName()
            name = 'CondColocPt2Pt2Pt';
        end

        function methods = getMethods(varargin)
            colocalizationMethods(1).name = 'Point2Point2Point';
            colocalizationMethods(1).func = @condColocPt2Pt2Pt;            
