classdef ColocalizationPt2PtProcess < ImageAnalysisProcess
...
% 
        ...
        function obj = ColocalizationPt2PtProcess(owner,varargin)
            ...
            if nargin == 0
                ...
                super_args{1} = owner;
                super_args{2} = ColocalizationPt2PtProcess.getName;
                super_args{3} = @colocalizationPt2PtWrapper;
                if isempty(funParams)
                    funParams = ColocalizationPt2PtProcess.getDefaultParams(owner,outputDir);
                end
